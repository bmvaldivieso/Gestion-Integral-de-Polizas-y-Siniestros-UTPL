    ...
    class Meta:
        ...
        widgets = {
            ...
            "codigo_activo": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Ej: ACT-001234"}
            ),
            "marca_bien": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Ej: Dell"}
            ),
            "modelo_bien": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Ej: Latitude 5420"}
            ),
            "serie_bien": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Ej: DL123456789"}
            ),
            "fecha_siniestro": forms.DateInput(
                attrs={"type": "date", "class": "form-control"}
            ),
            "tipo_siniestro": forms.Select(attrs={"class": "form-select"}),
            "ubicacion_siniestro": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Ej: Oficina 301, Edificio A",
                }
            ),
            "causa_siniestro": forms.Textarea(
                attrs={
            ...
            "nombre_custodio": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Nombre del responsable del bien",
                }
            ),
        }
