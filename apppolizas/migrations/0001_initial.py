    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('admin', 'Administrador de Pólizas'), ('analista', 'Analista de Seguros')], default='analista', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario_gestor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='polizas_gestionadas', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
