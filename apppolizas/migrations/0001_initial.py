                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "SINIESTRO_RESPUESTA_ASEG",
                                "Retraso Respuesta Aseguradora",
                            ),
                            ("OTRO", "Otro"),
                        ],
                        max_length=50,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "prima",
                    models.DecimalField(
                        decimal_places=2, help_text="Valor de la prima", max_digits=12
                    ),
                ),
                (
                    "contribucion_super",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="Monto bruto reclamado",
                        max_digits=12,
                    ),
                ),
                (
                    "valor_deducible",
                    models.DecimalField(
                        decimal_places=2, help_text="Deducible aplicado", max_digits=12
                    ),
                ),
                (
                    "valor_depreciacion",
                    models.DecimalField(
                        decimal_places=2,
                        default=0,
                        help_text="Depreciación del bien",
                        max_digits=12,
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="Valor líquido a recibir",
                        max_digits=12,
                    ),
                ),
                (
                    "documento_firmado",
                    models.FileField(blank=True, null=True, upload_to="finiquitos/"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "archivo",
                    models.FileField(
                        upload_to=apppolizas.models.ruta_documento_siniestro
                    ),
                ),
                (
                    "tipo",
